...
import { LayoutDashboard, Package, ShoppingBag, QrCode, Settings, TrendingUp, Clock, Loader2, AlertCircle } from 'lucide-react';
...
export default function AdminDashboardPage() {
  ...
  useEffect(() => { if (!token) { navigate('/admin'); return; } loadStats(); }, []);
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f8fafc', fontFamily: 'system-ui', direction: 'rtl', paddingBottom: 70 }}>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13, minWidth: 500 }}>
              ...
              <tbody>
                {stats?.recentOrders?.map(o => {
                  const statusColors = { pending: { bg: '#fef3c7', color: '#b45309' }, confirmed: { bg: '#dbeafe', color: '#1d4ed8' }, shipped: { bg: '#e0e7ff', color: '#4338ca' }, delivered: { bg: '#d1fae5', color: '#047857' }, cancelled: { bg: '#fee2e2', color: '#b91c1c' } };
                  const st = statusColors[o.status] || { bg: '#f1f5f9', color: '#475569' };
